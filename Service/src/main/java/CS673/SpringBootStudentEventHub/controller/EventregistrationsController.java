...
public class EventregistrationsController {
    ...
    public Eventregistrations getById(@PathVariable Integer Id) {
    ...
    public Eventregistrations add(@RequestBody Eventregistrations eventregistrations) {
        return null;
    }
    ...
    public Eventregistrations update(@RequestBody Eventregistrations eventregistrations) {
        return null;
    }
