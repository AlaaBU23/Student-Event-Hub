...
public class GroupmembersController {
    ...
    public Groupmembers getById(@PathVariable Integer Id) {
    ...
    public Groupmembers add(@RequestBody Groupmembers groupmembers) {
        return null;
    }
    ...
    public Groupmembers update(@RequestBody Groupmembers groupmembers) {
        return null;
    }
