...
public class AttendeesController {
    ...
    public Attendees getById(@PathVariable Integer Id) {
    ...
    public Attendees add(@RequestBody Attendees attendees) {
        return null;
    }
    ...
    public Attendees update(@RequestBody Attendees attendees) {
        return null;
    }
