...
public class EventgroupsController {
    ...
    public Eventgroups getById(@PathVariable Integer Id) {
    ...
    public Eventgroups add(@RequestBody Eventgroups eventgroups) {
        return null;
    }
    ...
    public Eventgroups update(@RequestBody Eventgroups eventgroups) {
        return null;
    }
